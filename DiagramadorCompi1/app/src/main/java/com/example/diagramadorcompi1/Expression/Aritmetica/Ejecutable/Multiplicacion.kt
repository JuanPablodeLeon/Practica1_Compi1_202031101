                ...
                when (rightType){
                    ...
                    TypeData.DECIMAL ->{
                        ...
                        if (leftValue is Number && rightValue is Number){
                            ...
                            return SintaxError("SINTACTICO","No se puede multiplicar valores no numericos", this.linea, this.columna)
                        }
                    }
                    else ->{
                        val error : SintaxError =
                            SintaxError("SINTACTICO", "Multuplicacion Invalida", this.linea, this.columna)
                        return  error
                    }
                }
            }
            ...
            TypeData.DECIMAL ->{
                when (rightType){
                    ...
                    TypeData.DECIMAL ->{
                        ...
                        val error : SintaxError =
                            SintaxError("SINTACTICO", "Multiplicacion Invalida", this.linea, this.columna)
                        return  error
                    }
                }
            }
